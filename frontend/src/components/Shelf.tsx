                      ...
                      return (
                        <ShelfCover
                          ...
                          */
                          ...
                          /*
                            **지우는 일은 서표가 맡습니다.** 한때 표지 하나로 둘을 다
                            하게 해서, 짚어 둔 책을 다시 누르면 열리지 않고 표시만
                            지워졌습니다. 지울 길이 생긴 대신 <b>「책 찾기」로 찾아간
                            책을 여는 데 두 번이 들었습니다.</b> 찾아간 책은 도착한
                            순간 이미 짚어 둔 상태인데, 찾은 사람이 그다음에 하려는
                            일은 지우는 것이 아니라 여는 것입니다.

                            서표는 짚어 둔 책에만 있으므로 <b>지울 것이 있을 때만
                            나타나는 단추</b>이고, 눌러서 지우면 그 단추도 함께
                            사라집니다. 여기서도 자리를 옮기지 않습니다.
                          */
