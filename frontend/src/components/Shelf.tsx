                      ...
                      return (
                        <ShelfCover
                          ...
                          */
                          onPick={() => {
                            /*
                              **짚어 둔 책을 다시 누르면 표시만 지웁니다. 열지 않습니다.**
                              표시는 하나뿐이라 다른 책을 누르면 저절로 옮겨 가지만,
                              <b>아무것도 짚지 않은 상태로 돌아갈 길이 없었습니다.</b>
                              기울어 선 책은 눈에 잘 띄라고 만든 것이라 볼일이 끝난 뒤에는
                              그만큼 거슬립니다.

                              **여기서 열지 않는 것이 중요합니다.** 열면서 지우면 방금 들여다본
                              책의 표시를 잃고, 열면서 그냥 두면 지울 길이 없어 처음으로
                              돌아갑니다. 그래서 이 한 번은 지우는 일만 합니다. 책이 눈앞에서
                              똑바로 서므로 무슨 일이 일어났는지는 바로 보이고, 한 번 더 누르면
                              다시 짚으면서 열립니다.
                            */
                            if (index === found) {
                              setFound(null);
